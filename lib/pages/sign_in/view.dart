  ...
  Widget build(BuildContext context) {
        ...
        child: Column(children: [
          Container(
            ...
            child: Stack(
              children: [
                Positioned(
                  child: Container(height: 76.w,decoration: BoxDecoration(color: AppColors.primaryBackground,
          ...
          Container(
            ...
            child: Text("Get Started",
              ...
              style: TextStyle(color: AppColors.thirdElement,
    ...
    Widget _buildThirdPartyLogin()
    {
      return Container(
        ...
        child: Column(children: [
          Text("Sign In with Social Network",
            textAlign: TextAlign.center,
